...
def index(request):
    ...
    if request.method == 'POST':
        ...
        if hora_inicio_texto[-2:] != "00" and hora_inicio_texto[-2:] != "30" and hora_inicio_texto != '':
            form.add_error("hora_inicio", "Reservas são aceitas apenas de 30 em 30 minutos.")
        if hora_fim_texto[-2:] != "00" and hora_fim_texto[-2:] != "30" and hora_fim_texto != '':
            form.add_error("hora_fim", "Reservas são aceitas apenas de 30 em 30 minutos.")
